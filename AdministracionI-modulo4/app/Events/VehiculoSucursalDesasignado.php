...
class VehiculoSucursalDesasignado implements ShouldBroadcast
{
    ...
    {
        return 'vehiculo_sucursal.desasignado';
    }
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'mensaje' => "Vehículo {$this->vehiculoSucursal->vehiculo->placa} desasignado de {$this->vehiculoSucursal->sucursal->nombre}",
